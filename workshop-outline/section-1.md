...
1. **Create the Studio site.** If you haven't already, create a new Studio site from the provided `blueprint.json` (Studio → **Add site → Start from a blueprint → Choose blueprint file**).
